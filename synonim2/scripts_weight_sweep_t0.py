"""
Igual que scripts_weight_sweep.py pero con el generador a temperature=0
(AGENTE_GENERADOR_T0) - el barrido original usaba temperature=0.3, que
introduce ruido de muestreo (~1-2pt hit@1 entre repeticiones) y confundía
la elección del peso ganador. Este script se corre 2 veces (ver
EXPERIMENTS_LOG.md) para comprobar que el peso elegido es estable incluso a
temperature=0 (Ollama no es perfectamente determinista).
...
summary_df.to_csv(f"results/eval/weight_sweep_val_t0_run{run_id}.csv", index=False)
